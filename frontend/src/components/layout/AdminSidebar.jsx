  ...
  return (
    ...
    >
      ...
      <nav className={cn("w-full flex flex-col", !isOpen && "items-center")}>
        <AdminNavItem to="/admin/dashboard" icon={LayoutDashboard} label="Dashboard" isOpen={isOpen} pathname={location.pathname} />
        <AdminNavItem to="/admin/users" icon={Users} label="Manage Users" isOpen={isOpen} pathname={location.pathname} />
        <AdminNavItem to="/admin/documents" icon={FileText} label="Manage Documents" isOpen={isOpen} pathname={location.pathname} />
        <AdminNavItem to="/admin/subjects" icon={BookOpen} label="Subjects" isOpen={isOpen} pathname={location.pathname} />
        <AdminNavItem to="/admin/settings" icon={Settings} label="Settings" isOpen={isOpen} pathname={location.pathname} />
      </nav>
    </aside>
  );
}