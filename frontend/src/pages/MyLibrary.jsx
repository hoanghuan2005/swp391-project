  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            Manage your uploaded materials and study workspaces.
          </p>
        </div>
      </div>
      ...
      <Tabs defaultValue="projects" className="w-full">
        {/* TAB NAVIGATION LIST */}
        <TabsList className="bg-orange-50/80 p-1 rounded-2xl mb-8 flex flex-wrap h-auto gap-1">
          <TabsTrigger
            value="documents"
            className="rounded-xl px-6 py-2.5 data-[state=active]:bg-white data-[state=active]:shadow-sm font-bold"
          >
            <FileText className="w-4 h-4 mr-2 text-[#f26522]" /> My Uploads
          </TabsTrigger>
          <TabsTrigger
            value="projects"
            className="rounded-xl px-6 py-2.5 data-[state=active]:bg-white data-[state=active]:shadow-sm font-bold"
          ...
          <TabsTrigger
            ...
            className="rounded-xl px-6 py-2.5 data-[state=active]:bg-white data-[state=active]:shadow-sm font-bold"
          >
            <Layers className="w-4 h-4 mr-2 text-[#f26522]" /> My Flashcards
          </TabsTrigger>
          <TabsTrigger
            value="quizzes"
            className="rounded-xl px-6 py-2.5 data-[state=active]:bg-white data-[state=active]:shadow-sm font-bold"
          >
            <ListChecks className="w-4 h-4 mr-2 text-[#f26522]" /> My Quizzes
          </TabsTrigger>
        </TabsList>
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              {documents.map((doc) => (
                <div
                  key={doc.id}
                  className="rounded-xl border border-slate-100 bg-white shadow-sm hover:shadow-md transition-all overflow-hidden"
                >
                  <div className="flex items-center gap-4 p-4">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="p-2 rounded-md text-slate-600 hover:text-white hover:bg-[#f26522] transition-colors cursor-pointer"
                        title="Edit"
                      >
                      ...
                      <button
                        ...
                        className="p-2 rounded-md text-slate-600 hover:text-white hover:bg-red-500 transition-colors cursor-pointer"
                        title="Delete"
                      >
                        <Trash2 className="w-4 h-4" />
                      </button>
        ...
        <TabsContent value="flashcards" className="mt-0">
          <div className="flex flex-col items-center justify-center py-20 text-center bg-slate-50 rounded-[32px] border border-dashed border-slate-200">
            ...
            <p className="text-slate-500 mb-6 max-w-sm">
              Saved AI-generated flashcards will appear here.
            </p>
          </div>
        </TabsContent>
        ...
        <TabsContent value="quizzes" className="mt-0">
          <div className="flex flex-col items-center justify-center py-20 text-center bg-slate-50 rounded-[32px] border border-dashed border-slate-200">
            ...
            <p className="text-slate-500 mb-6 max-w-sm">
              Past quiz attempts and saved test sets will show up here.
            </p>
          </div>
        </TabsContent>
      </Tabs>
