...
export default function ProfilePage() {
  ...
  // States quản lý dữ liệu danh sách chọn (giống bên Survey)
  ...
  // Sửa lỗi: Lưu file thực tế vào State để handleSaveProfile không bị bỏ qua điều kiện
  ...
  const handleSaveProfile = async (e) => {
    ...
    try {
      ...
      // Bước A: Xử lý Upload Avatar nếu có chọn hình mới
      if (selectedFile) {
      ...
      // Bước B: Đồng bộ gửi 3 trường học vấn lên API /api/survey của Backend Spring Boot
      const surveyPayload = {
      ...
      // Cập nhật lại State hiển thị trên cục bộ Frontend sau khi lưu thành công
      setProfileData((prev) => ({
        ...prev,
        ...
        <div className="space-y-6">
          <Card className="border-gray-100 shadow-md overflow-hidden bg-white rounded-2xl">
            <CardContent className="pt-8 pb-6 flex flex-col items-center text-center">
              ...
              {/* Hiển thị nhanh các tag ngôn ngữ đang học dưới Avatar */}
          ...
          <Card className="border-gray-100 shadow-md bg-white rounded-2xl h-full">
            ...
            <CardContent className="p-6">
              <form onSubmit={handleSaveProfile} className="space-y-5">
                ...
                {/* Trường học (Chuyển từ Input khóa sang Dropdown Select động) */}
                <div className="space-y-1.5">
                  <label className="text-sm font-bold text-slate-700 ml-0.5 flex items-center gap-1.5">
                ...
                {/* Năm bắt đầu (Thêm mới trường thông tin) */}
                <div className="space-y-1.5">
                  <label className="text-sm font-bold text-slate-700 ml-0.5 flex items-center gap-1.5">
                ...
                {/* Ngôn ngữ học tập (Thêm mới vùng chọn dạng nút bấm tiện lợi giống Survey) */}
                      ...
                      languageOptions.map((language) => {
                        ...
                        return (
                          <Button
                            ...
                            className={`rounded-full h-8 px-4 text-xs font-semibold transition ${
                              isSelected
